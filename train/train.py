...
from envs.env_wrappers import DummyVecEnv  # TODO 随着版本的不同，这里的envs后缀会变！！！！！！！

# SECTION 注意上面这句
from envs.base import base
base = base()   # todo 主要是用来传个数的
...
def parse_args(args, parser):
    ...
    parser.add_argument("--num_agents", type=int, default=base.num_uav, help="number of players")   # point 在这里改agent数量
